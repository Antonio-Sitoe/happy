...
const schema = yup
  .object({
    ...
    whatsappNumber: yup
      .string()
      .min(11, "Digite no minímo 11 caracteres")
      .required("Informe o número do seu whatsapp ou de contato"),
        ...
        <Container>
          <section className="section-dados">
            ...
            <div className="field">
              ...
              {errors.name && (
                <span className="error-alert">{errors.name?.message}</span>
              )}
            </div>
            ...
            <div className="field">
              ...
              />
              {errors.about && (
                <span className="error-alert">{errors.about?.message}</span>
              )}
            </div>
          ...
          <section className="section-validacao">
            ...
            <div className="field">
              ...
              />
              {errors.visitHour && (
                <span className="error-alert">{errors.visitHour?.message}</span>
              )}
            </div>
          </section>
